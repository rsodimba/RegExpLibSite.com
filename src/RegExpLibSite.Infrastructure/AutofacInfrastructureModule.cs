...
using Autofac;
using RegExpLibSite.Core.ContributorAggregate;
using RegExpLibSite.Core.Interfaces;
using RegExpLibSite.Infrastructure.Data;
using RegExpLibSite.Infrastructure.Data.Queries;
using RegExpLibSite.Infrastructure.Email;
using RegExpLibSite.UseCases.Contributors.Create;
using RegExpLibSite.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace RegExpLibSite.Infrastructure;
